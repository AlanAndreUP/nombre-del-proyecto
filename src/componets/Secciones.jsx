...
const Secciones = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch(
        "http://alansanchez12-001-site1.htempurl.com/api/Categorias"
      );
  ...
  const editar = async () => {
    try {
      const response = await fetch(
        `http://alansanchez12-001-site1.htempurl.com/api/Categorias/${form.id}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  const eliminar = async (id) => {
    try {
      const response = await fetch(
        `http://alansanchez12-001-site1.htempurl.com/api/Categorias/${id}`,
        {
          method: "DELETE",
        }
      );
    ...
    <>
      <div className="menu-tablas-container">
        <Container>
          ...
          <br />
          <center>
            <h1 style={{ color: "white" }}>REGISTRO DE CATEGORIAS</h1>
          </center>
