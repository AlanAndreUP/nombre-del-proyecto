...
const Apertura = () => {
  ...
  const [mon5OC, aperturae, setUserName] = useState('');
  ...
  return (
    <div className="container-fluid contsfondo">
      <Row>
        <h1 className='text-center text-white'>Cierre de caja</h1>
        <Col xs={12} md={4}>
